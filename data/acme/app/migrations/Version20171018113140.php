 ...
 */
class Version20171018113140 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sylius_authors (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, year_birth VARCHAR(4) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sylius_books (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, year_issue VARCHAR(4) NOT NULL, UNIQUE INDEX UNIQ_DEA418F32B36786B (title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_libraries (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sylius_authors_books ADD CONSTRAINT FK_C15A97E5F675F31B FOREIGN KEY (author_id) REFERENCES sylius_authors (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE sylius_authors_books ADD CONSTRAINT FK_C15A97E516A2B381 FOREIGN KEY (book_id) REFERENCES sylius_books (id) ON DELETE CASCADE');
