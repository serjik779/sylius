 ...
 */
class Version20171018130303 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_authors CHANGE year_birth year_birth DATETIME NOT NULL');
        $this->addSql('ALTER TABLE sylius_books CHANGE year_issue year_issue DATETIME NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_authors CHANGE year_birth year_birth VARCHAR(4) NOT NULL COLLATE utf8_unicode_ci');
        $this->addSql('ALTER TABLE sylius_books CHANGE year_issue year_issue VARCHAR(4) NOT NULL COLLATE utf8_unicode_ci');
