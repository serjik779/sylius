 ...
 */
class Version20171019105058 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE books_libraries');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE books_libraries (books_id INT NOT NULL, libraries_id INT NOT NULL, INDEX IDX_646AA3177DD8AC20 (books_id), INDEX IDX_646AA3178F46A49D (libraries_id), PRIMARY KEY(books_id, libraries_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE books_authors ADD CONSTRAINT FK_877EACC26DE2013A FOREIGN KEY (authors_id) REFERENCES sylius_authors (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE books_authors ADD CONSTRAINT FK_877EACC27DD8AC20 FOREIGN KEY (books_id) REFERENCES sylius_books (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE books_libraries ADD CONSTRAINT FK_646AA3177DD8AC20 FOREIGN KEY (books_id) REFERENCES sylius_books (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE books_libraries ADD CONSTRAINT FK_646AA3178F46A49D FOREIGN KEY (libraries_id) REFERENCES sylius_libraries (id) ON DELETE CASCADE');
