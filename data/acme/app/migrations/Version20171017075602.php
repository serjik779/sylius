 ...
 */
class Version20171017075602 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE SliderImage DROP FOREIGN KEY FK_B8DB64477E3C61F9');
        $this->addSql('CREATE TABLE sylius_slider_images (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_46E19B497E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_slider (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F5E6FEFB5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE sylius_slider_images ADD CONSTRAINT FK_46E19B497E3C61F9 FOREIGN KEY (owner_id) REFERENCES sylius_slider (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_slider_images DROP FOREIGN KEY FK_46E19B497E3C61F9');
        $this->addSql('CREATE TABLE Slider (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, UNIQUE INDEX UNIQ_C86B15315E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE SliderImage (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, type VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci, path VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, INDEX IDX_B8DB64477E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('DROP TABLE sylius_slider_images');
        $this->addSql('DROP TABLE sylius_slider');
